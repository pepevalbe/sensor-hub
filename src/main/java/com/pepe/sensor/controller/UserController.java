...
import static com.pepe.sensor.VarKeeper.USER_REGISTRY_ENABLED_KEY;
...
public class UserController {
	...
	private static final String PUBLIC_USERPROFILE_URL = "/public/userprofile";
	private static final String PUBLIC_CREATEUSER_URL = "/public/createuser";
	private static final String USER_MODIFYUSER_URL = "/user/modifyuser";
	 ...
	 */
	@GetMapping(PUBLIC_USERPROFILE_URL)
	...
	public ResponseEntity<String> createUser(@RequestBody PersonDto userDTO) {
		...
		if (Boolean.parseBoolean(varKeeper.get(USER_REGISTRY_ENABLED_KEY))) {
	 ...
	 */
	@PostMapping(USER_MODIFYUSER_URL)
